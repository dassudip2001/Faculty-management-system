<div class="card mt-4 mx-2">
    <div class="card-title mx-2 mt-2">
        ...
        <br>
        <form action="" method="GET" class="d-flex"><input class="form-control me-2  type=" text" name=" search" placeholder=" Search" aria-label=" Search" required>
                   ...
                   <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col">
                          {{-- select  --}}
                          <div class="container">
                            <div class="card model_card mb-3 mt-3">
                                <div class="row">
                        ...
                        <div class="col">
                          {{-- upload module --}}
                          <div class="container"  >
                            <div class="card model_card mb-3 mt-3" style="max-width: 540px;">
